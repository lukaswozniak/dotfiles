...
install_i3wm_arch: xorg_arch fonts_arch yay
	@sudo pacman -S i3-gaps xss-lock i3lock xcompmgr dmenu network-manager-applet pulseaudio pulseaudio-alsa pavucontrol playerctl dbus python-dbus --noconfirm --needed
